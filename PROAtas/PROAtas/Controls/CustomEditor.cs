...
namespace PROAtas.Controls
{
    public class CustomEditor : Editor
    {
        ...
        public static readonly BindableProperty SaveCommandProperty = BindableProperty.Create(nameof(SaveCommand), typeof(ICommand), typeof(CustomEditor), default(ICommand));
        ...
        public static readonly BindableProperty SaveCommandParameterProperty = BindableProperty.Create(nameof(SaveCommandParameter), typeof(object), typeof(CustomEditor), default(object));
        ...
        public static readonly BindableProperty IsSavingProperty = BindableProperty.Create(nameof(IsSaving), typeof(bool), typeof(CustomEditor), false);
    }
}
