...
namespace PROAtas.Extensions
{
    public static class MessagingCenterExtensions
    {
        ...
        public static void SubscribeSafe<TArgs>(this IMessagingCenter messagingCenter, 
            object subscriber, string message, Action<TArgs> callback, TArgs source = null) where TArgs : class
        {
        ...
        /// </summary>
        public static void SubscribeSafe<TArgs>(this IMessagingCenter messagingCenter, 
            object subscriber, string message, Func<TArgs, Task> callback, TArgs source = null) where TArgs : class
        {
            MessagingCenter.Unsubscribe<TArgs>(subscriber, message);
        ...
        public static void SubscribeSafe<TSender, TArgs>(this IMessagingCenter messagingCenter, 
            object subscriber, string message, Action<TSender, TArgs> callback, TSender source = null) where TSender : class
        {
