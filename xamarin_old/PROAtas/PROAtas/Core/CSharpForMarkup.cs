...
namespace CSharpForMarkup // Version 20191118.1; guidance at https://github.com/VincentH-Net/CSharpForMarkup; Xamarin Forms PR at https://github.com/xamarin/Xamarin.Forms/pull/8342
{
    public static class XamarinFormsMarkupExtensions
    {
        ...
        public static TView BindBehavior<TView>(this TView view, BindableProperty targetProperty, string sourcePropertyName = bindingContextPropertyName, BindingMode mode = BindingMode.Default, IValueConverter converter = null, object converterParameter = null, string stringFormat = null, object source = null, object targetNullValue = null, object fallbackValue = null) where TView : Behavior
        {
            if (source != null || converterParameter != null || targetNullValue != null || fallbackValue != null)
                view.SetBinding(targetProperty, new Binding(
                    path: sourcePropertyName,
        ...
        public static TView BindBehavior<TView, TSource, TDest>(this TView view, BindableProperty targetProperty, string sourcePropertyName = bindingContextPropertyName, BindingMode mode = BindingMode.Default, Func<TSource, TDest> convert = null, Func<TDest, TSource> convertBack = null, object converterParameter = null, string stringFormat = null, object source = null, object targetNullValue = null, object fallbackValue = null) where TView : Behavior
        {
            var converter = new FuncConverter<TSource, TDest>(convert, convertBack);
            if (source != null || converterParameter != null || targetNullValue != null || fallbackValue != null)
                view.SetBinding(targetProperty, new Binding(
